...
```bash
# 需要 ppt-master（可选），路径见 config.yaml → engines.ppt-master.path
python3 <ppt-master>/skills/ppt-master/scripts/source_to_md/pdf_to_md.py input.pdf -o output.md
```
...
| Markdown 转换 | pdf_to_md.py (ppt-master) |
...
- pdf_to_md.py (ppt-master) — 安装: `git clone https://github.com/hugohe3/ppt-master.git`
