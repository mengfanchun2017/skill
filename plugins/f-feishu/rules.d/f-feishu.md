...
> 飞书文档硬约束，始终加载。完整规则+工作流 → `f-feishu` skill；参考手册 → `skills/f-feishu/references/write-checklist.md`
...
## 入口
所有文档操作由 `f-feishu` skill 编排。写操作关键检查已内联在 SKILL.md 工作流步骤中。

## 图子文档约定（数据/分析图）
- **何时用**：数据图/分析图/对比图。架构/流程图委托 f-diagram
